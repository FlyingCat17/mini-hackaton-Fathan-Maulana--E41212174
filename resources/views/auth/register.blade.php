...
@section('content')
    <div class="card w-5/6 bg-white p-8 md:w-[30rem]">
        <div class="flex flex-col">
            ...
            <div id="title">
                <h1 class="text-xl font-bold text-center mb-6">CREATE YOUR OWN ACCOUNT</h1>
            </div>
            ...
            <form action="{{ route('register.store') }}" method="post">
                ...
                <div class="form-control mt-4">
                    <div class="flex items-center relative w-full">
                        ...
                        <input type="text"
                            class="w-full h-[40px] py-7 rounded-lg pl-14 border-2 transition-all duration-200 ease-in-out outline-none text-[#0d0c22] bg-white text-sm md:text-md focus:shadow-lg pr-4 @error('name') border-red-400 @enderror"
                ...
                <div class="form-control mt-4 mb-8">
                    <div class="flex items-center relative w-full">
                        ...
                        <input type="password"
                            class="w-full h-[40px] py-7 rounded-lg pl-14 border-2 transition-all duration-200 ease-in-out outline-none text-[#0d0c22] bg-white text-sm md:text-md focus:shadow-lg pr-4 @error('password_confirmation') border-red-400 @enderror"
                ...
                <button type="submit" class="btn w-full border-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:border-white">CREATE
                    ACCOUNT</button>
            </form>
            <a href="{{ route('login.create') }}" class="btn btn-error text-white mt-4">BACK TO LOGIN</a>
